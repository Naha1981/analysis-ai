...
app.post('/api/analyze', async (req, res) => {
  try {
    ...
    try {
      ...
      try {
        // Generate content from the AI API with proper error handling
        ...
        // Generate content with proper format for the API version
        ...
        throw new Error(`Gemini API generation error: ${generationError.message}`);
      }
    } catch (apiError) {
      ...
      try {
        ...
        res.json({ 
          ...
          note: 'Generated using local analysis due to API error: ' + apiError.message
        });
      } catch (fallbackError) {
